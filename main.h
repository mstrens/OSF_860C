...
#include "common.h"
                                    // !!!!!!!!!!!!!!
#define FIRMWARE_VERSION "0.1.25"      //  !!! this version was derived from 0.1.13 for vlcd5 !!!!!!!!!!
...
#define USE_SPIDER_LOGIC_FOR_TORQUE (1) // (1) = use Spider logic with a buffer of 20 value over one rotation.
